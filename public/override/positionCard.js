...
window.generate = () => {
   ...
   <div class="order-share-body" data-v-70eaf828="">
      ...
      <div class="order-info" data-v-70eaf828="">
         ...
         <div class="rtl-text-ta-right profit min-profit din-pro ${card.ratio < 0 ? "down":""}" data-v-70eaf828="" style="font-size: 40px;font-weight: ${(+(+card.ratio).toFixed(2)+"")?.replace("-","")?.length <= 4 ? "bolder":"unset"}"><span class="profit-text" data-v-70eaf828="">${+(+card.ratio).toFixed(2)}<span>%</span></span></div>
