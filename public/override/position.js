...
function calculateRisk(lastPrice, liquid, type = "long", position, pnl) {
    ...
    final = (5 / 100) * final;
    return (+Math.min(+`4.${generateRandomString("1234567890",1)}`,Math.max(final, +position.randomized))).toFixed(2);
}
            ...
            <div class="top-wrapper" data-v-db2fc607="">
                            ...
                            <div class="data-wrapper" data-v-db2fc607="">
                                <div class="item" data-v-db2fc607="">
                                    ...
                                    <p class="value up" data-v-db2fc607="">${(Math.max(posSize + (-pnl), 31.68)).toFixed(2)}</p>
                                </div>
                                <div class="item" data-v-db2fc607="">
